        ...
        return (
            ...
            <Content>
                ...
                <View style={styles.descRow}>
                    ...
                    <Text
                        style={[styles.smallText, { width: width - 50 }]}>{'Information Security @ Tech Mahindra'}</Text>
                </View>
                <View style={styles.descRow}>
                    <Image source={education} style={styles.smallIcon} />
                    <Text
                        style={[styles.smallText, { width: width - 50 }]}>{'The Ontario College of Art and Design University'}</Text>
                </View>
                <View style={styles.descRow}>
                    <Image source={houseOutline} style={styles.smallIcon} />
                    <Text
                        style={[styles.smallText, { width: width - 50 }]}>{'Pennsylvania'}</Text>
                </View>
                <Text style={{
                    marginTop: 10, marginLeft: 10, color: 'black',
                    fontWeight: 'bold',
